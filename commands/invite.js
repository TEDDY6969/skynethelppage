...
const embed = new Discord.RichEmbed()
  ...
  .setColor('RANDOM')
  .addField("``Links``  <a:redBadge:819501788766928927> ", "[Invite the bot here (Recomended!)](" + `https://discord.com/api/oauth2/authorize?client_id=819172557067386891&permissions=8&scope=bot` + ") \n[ Invite The Bot Here (Normal)](https://discord.com/api/oauth2/authorize?client_id=819172557067386891&permissions=8&scope=bot" + `${client.user.id})`)
